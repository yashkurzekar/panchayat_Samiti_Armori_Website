! function(t) {
    ...
    j((function() {
        ...
        return t.prototype.onSliderExists = function(t, s, n) {
            if (this.__sliderElement = n, this.U = n.closest(".n2-section-smartslider"), this.H = this.U.querySelector("ss3-loader"), this.stages.resolve("Exists"), "TEMPLATE" === n.tagName) {
                ...
                var o = m(n, "loadingType"),
                    ...
                    c = function() {
                        h.appendChild(a), k(this.U, "height"), this.waitForDimension(a, s), D(i, "n2Rocket", {
                            sliderElement: a
                        })
                    }.bind(this);
                "afterOnLoad" === o ? u.r("windowLoad", l.bind(this, this.U, c)) : "afterDelay" === o ? r(c, m(n, "loadingDelay")) : c()
            ...
            if (!this.isAdmin && this.parameters.playWhenVisible && i.IntersectionObserver) {
                ...
                o.observe(this.sliderElement), this.Z = [h.disconnect.bind(h), o.disconnect.bind(o), L(this.sliderElement, "pointerover", this._markVisible.bind(this))]
            } else this.stages.resolve("Visible")
        }, t.prototype._markVisible = function() {
            this.Z && z(this.Z), this.stages.resolve("Visible")
        ...
        function t(t, s) {
            this.J = t, this.tt = t.sliderElement, this.it = t.U, this.st = m(this.it, "alias"), this.nt = f({
                id: 0,
                smoothScroll: 0,
                slideSwitch: 0,
                scroll: 1
            }, s), this.st && (this.nt.smoothScroll && y(o, "scroll-behavior", "smooth"), this.nt.slideSwitch && (this.switchOnLoad(), O(i, "hashchange", function() {
                var t = this.getAnchor();
                t > 0 && (1 === this.J.responsive.parameters.focusUser ? (this.J.responsive.parameters.focusUser = 0, this.switchToSlide(t - 1), this.J.responsive.parameters.focusUser = 1) : this.switchToSlide(t - 1), this.replaceHash())
            }.bind(this))))
        }
        ...
        function t(i, s, n) {
            this.slider = i, this.responsive = this.slider.responsive, this._type = this.responsive.parameters.type, this._upscale = this.responsive.parameters.upscale, this.et = !1, this.tt = this.slider.sliderElement, this.ot = this.tt.closest(".n2-section-smartslider"), O(h, t.event, this.fullScreenChange.bind(this))
        }
        return t.isSupported = !(!h.exitFullscreen && !h.webkitExitFullscreen), t.isSupported && (t.requestFullscreen = o.requestFullscreen || o.webkitRequestFullscreen, t.exitFullscreen = h.exitFullscreen || h.webkitExitFullscreen, t.event = o.requestFullscreen ? "fullscreenchange" : o.webkitRequestFullscreen ? "webkitfullscreenchange" : null), t.prototype.switchState = function() {
            ...
            this.isDocumentInFullScreenMode() ? (this.slider.K("n2FullScreen"), A(o, "n2-in-fullscreen"), A(this.slider.sliderElement, "n2-ss-slider--fullscreen"), this.et = !0, "auto" === this._type && y(this.slider.responsive.alignElement, "max-width", "none"), F(i, "resize")) : (this.responsive.et = !1, this.responsive.parameters.type = this._type, this.tt.dataset.responsive = this._type, this.responsive.parameters.upscale = this._upscale, g(this.responsive.containerElement, {
                ...
                height: "",
                "background-color": ""
            }), I(this.slider.sliderElement, "n2-ss-slider--fullscreen"), I(o, "n2-in-fullscreen"), "auto" === this._type && k(this.slider.responsive.alignElement, "max-width"), F(i, "resize"), this.et = !1, this.slider.K("n2ExitFullScreen"))
        ...
        function t(t, i) {
            this.preventScroll = {
                ...
                globalTimeout: !1
            }, this.maxDelta = 0, this.slider = t, this.rt = 2 === i ? "deltaX" : "deltaY", h.addEventListener("wheel", this.onGlobalMouseWheel.bind(this), {
                passive: !1
        ...
        return t.prototype.onStarterSlide = function() {
            ...
            "vertical" === this.axis && (this.slider.controlFullscreen && this.slider.controlFullscreen.et || (this.currentInteraction.action = "scroll", "pointer" === this.currentInteraction.type && (y(o, "scroll-behavior", "auto"), V(Math.max(0, this.currentInteraction.scrollTop - t)))))
        ...
        return t.prototype.focus = function() {
            ...
            m(this.element, "hide" + H(t)) ? !1 !== this.isVisible && (this.isVisible = !1, this.slider.responsive.visibleRealSlidesChanged = !0, this.K("Hidden")) : (this.slider.visibleRealSlides.push(this), !0 !== this.isVisible && (this.isVisible = !0, this.slider.responsive.visibleRealSlidesChanged = !0, this.K("Visible")))
        ...
        return t.prototype.isStatic = function() {
            ...
            m(this.element, "hide" + H(t)) ? !1 !== this.isVisible && (this.isVisible = !1, this.K("Hidden")) : !0 !== this.isVisible && (this.isVisible = !0, this.status.is("INITIALIZED") && this.playIn(), this.K("Visible"))
        }, t
        ...
        function l(t, s) {
            for (var n in this.state = {
                    StarterSlide: !1
                }, this.isVisible = !0, this.isResetActiveSlideEarly = this.isResetActiveSlideEarly || !1, this.focusOffsetTop = 0, this.focusOffsetBottom = 0, this.minimumSlideHeight = 0, this.et = !1, this.visibleRealSlidesChanged = !0, this.vt = -1, this.bt = -1, this.St = -1, this.wt = -1, this.filters = {
                    SliderWidth: [],
                    SliderHeight: [],
                    SlideHeight: [],
                    SliderVerticalCSS: []
            ...
            this.parameters.hideOn = i.ssOverrideHideOn || this.parameters.hideOn, this.doThrottledResize = NextendThrottle(this.doResize.bind(this), 50), this.slider = t, this.sliderElement = t.sliderElement, this.yt = "1" === m(this.sliderElement, "ssLegacyFontScale"), this.addFilter("SliderWidth", this.filterSliderWidthHorizontalSpacing.bind(this))
        }
        return h.addEventListener("scroll", (function() {
            ...
            this.vt = i.innerWidth, this.bt = i.innerHeight, this.slider.mainAnimation && "playing" === this.slider.mainAnimation.getState() ? this.gt || (this.gt = !0, T(this.sliderElement, "mainAnimationComplete", this._onResize.bind(this, e))) : this._onResize(e)
        }, l.prototype._onResize = function(e) {
            this.doResize(e), delete this.gt
            ...
            if (!this.slider.isAdmin && c && this.St === this.vt) {
                const t = Math.abs(this.wt - this.bt);
                if (t > 0 && t < 100) return
            }
            this.St = this.vt, this.wt = this.bt;
            var t = this.identifyDeviceID();
            if (this.parameters.hideOn[l._DeviceMode[t]]) return A(this.U, "n2-section-smartslider--hidden"), !1;
            if (I(this.U, "n2-section-smartslider--hidden"), !this.isVisible) return !1;
            var i = !1,
                s = this.device;
            if (this.deviceID !== t && (this.setDeviceID(t), s && I(this.sliderElement, "n2-ss-" + s), b(this.sliderElement, "deviceMode", this.device), A(this.sliderElement, "n2-ss-" + this.device), this.slider.K("SliderDevice", {
                    lastDevice: s,
                    device: this.device,
                    ...
                    device: this.device,
                    group: l._DeviceGroup[this.device]
                }), this.slider.stages.resolve("DeviceOrientation"), this.finalizeVisibleSlidesStage1()), !this.slider.visibleRealSlides.length) return this.parameters.hideOn[l._DeviceMode[t]] = !0, A(this.U, "n2-section-smartslider--hidden"), !1;
            ...
            }, this.yt && C(this.sliderElement.querySelectorAll('.n2-ss-layer[data-sstype="slide"] > .n2-ss-layer[data-pm="absolute"][data-adaptivefont="0"]'), "font-size", "calc(" + 16 * this.ratios.slideW + "px * var(--ssfont-scale, 1))");
            ...
            this.visibleRealSlidesChanged && (this.visibleRealSlidesChanged = !1, this.isResetActiveSlideEarly || this.calibrateActiveSlide(), this.triggerVisibleSlidesChanged(), this.targetCurrentSlide !== n && (this.slider.K("SlideWillChange", {
