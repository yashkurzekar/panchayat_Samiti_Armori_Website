! function(t) {
    ...
    var s = t.document,
        h = (s.documentElement, t.setTimeout),
        n = t.clearTimeout,
        a = i._N2,
    ...
    ! function(t) {
        ...
        return t.prototype = Object.create(a.SmartSliderMainAnimationAbstract.prototype), t.prototype.constructor = t, t.prototype.changeTo = function(t, i, s, h) {
            ...
            if (0 !== this.parameters.shiftedBackgroundAnimation) {
                var h = !1,
                    n = !1;
                if ("auto" === this.parameters.shiftedBackgroundAnimation ? t.hasLayers() ? h = !0 : n = !0 : h = !0, this._currentBackgroundAnimation && h) {
                ...
                } else n && (s.extraDelay > 0 && this.timeline.shiftChildren(s.extraDelay), this._currentBackgroundAnimation.shiftedPreSetup && this._currentBackgroundAnimation._preSetup())
            } else !1 !== this._currentBackgroundAnimation && (s.outDelay += .1);
            var r = [t.SMWs[0]];
            ...
            this.showSlide(i), this.__mainAnimationDirection(t, i, "vertical", !s)
        }, t.prototype.__mainAnimationDirection = function(t, i, s, h) {
            var n = t.SMWs,
                o = i.SMWs,
                r = [t, i],
                c = "",
                l = 0;
            "horizontal" === s ? (c = "x", l = Math.floor(this.slider.responsive.resizeContext.slideOuterWidth), n2const.rtl.isRtl && (h = !h)) : "vertical" === s && (c = "y", l = Math.floor(this.slider.responsive.resizeContext.slideOuterHeight)), h && (l *= -1);
            var f = {},
                v = {
                    snap: "x,y",
                    ease: this.getEase()
            ...
            if (this.timeline.to(n, S.outDuration, d, S.outDelay), this.isTouch && this.isReverseAllowed)
                if (h ? this.slider.blockCarousel && this.slider.isChangeCarousel("next") || (p = t.getNext()) : this.slider.blockCarousel && this.slider.isChangeCarousel("previous") || (p = t.getPrevious()), p && p !== i) {
                    ...
                    I[c] = 0, A[c] = -l, C[c] = l, w[c] = 0, p.K("mainAnimationStartIn", {
                        mainAnimation: this,
                        previousSlideIndex: t.index,
                        currentSlideIndex: p.index,
                        isSystem: !1
                    }), this.reverseTimeline.paused(!0), this.reverseTimeline.eventCallback("onComplete", this.onBackwardChangeToComplete.bind(this), [t, p, !1]), this.reverseTimeline.fromTo(D, S.inDuration, A, I, S.inDelay), this.reverseTimeline.fromTo(n, S.inDuration, w, C, S.inDelay)
        ...
        function t() {
            this.round = 1, a.SmartSliderResponsive.prototype.constructor.apply(this, arguments), this.xt = this.sliderElement.classList.contains("n2-ss-full-page--constrain-ratio"), this.mainAnimation = this.slider.mainAnimation
        }
        return t.prototype = Object.create(a.SmartSliderResponsive.prototype), t.prototype.constructor = t, t.prototype.init = function() {
            ...
            var h = this._cacheEl.slider.getBoundingClientRect();
            this.resizeContext.sliderWidth = h.width, this.resizeContext.sliderHeight = h.height;
            var n = this._cacheEl["n2-ss-slider-3"].getBoundingClientRect();
            if (this.resizeContext.slideOuterWidth = n.width, this.resizeContext.slideOuterHeight = n.height, a.SmartSliderResponsive.prototype.calculateResponsiveValues.call(this), this.xt) {
